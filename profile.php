...
<section class="tabs">
  ...
  <section class="tab-content">
    ...
    <section class="active">
      ...
      <div class="container">
          <div class="row">
          <?php 		$sql=mysqli_query($con,"select * from profile where userid ='".$_SESSION['userid']."'");
while($data=mysqli_fetch_array($sql)){
    ?>
            <div class="col-md-6">
              <label>Univ. Roll No.</label>
              <input type="number" name="userid" value="<?php echo htmlentities($data['userid']);?>" class="form-control" placeholder="Roll No." required>
            </div>
            <?php } ?>
            <div class="col-md-6">
              <label>Name</label>
              <input type="text" name="userlname"  class="form-control" placeholder="Name" required>
            </div>
            ...
            <div class="col-md-6 my-2">
              <label>Year</label>
              <input type="number" name="useryear"  class="form-control" placeholder="Year" required>
            </div>
            ...
            <div class="col-md-12 my-2">
              ...
              <!-- <textarea name="userinfo"  class="form-control" aria-label="With textarea" rows="6" required></textarea> -->
            </div>
    ...
    <section>
     ...
     <form action="skills.php" method="POST">
         ...
         <div class="col-md-6 my-2">
              <label>Univ. Roll No.</label>
              <input type="number" name="userid" class="form-control" placeholder="Roll No">
         </div>
        Select Skill(s):- (USE Ctrl FOR MULTY SELECT) </br>

      <div class="col-md-6 my-2">
       <input type="checkbox" name="skill[]" multiple="multiple">
            <option type="checkbox" value="python">python python python python python python </option>
            <option type="checkbox" value="java">java</option>
            <option type="checkbox" value="ml">ml</option>
            <option type="checkbox" value="ai">ai</option>
            <option type="checkbox" value="iot">iot</option>
            <option type="checkbox" value="html">html</option>
            <option type="checkbox" value="css">css</option>
            <option type="checkbox" value="js">js</option>
